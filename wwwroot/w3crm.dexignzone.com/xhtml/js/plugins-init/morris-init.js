	...
	var dlabMorris = function(){
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(13,153,255)', 'rgb(0, 181, 198)', '#0d99ff'],
				resize: true
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#0d99ff', 'rgb(16, 202, 148)', 'rgb(255, 92, 0)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
		...
		var areaChart2 = function(){
			...
			//area chart
				Morris.Area({
					...
					smooth: false,
					hideHover: 'auto',
					lineColors: ['rgb(0, 181, 198)', 'rgb(0, 0, 128)'],
					resize: true
