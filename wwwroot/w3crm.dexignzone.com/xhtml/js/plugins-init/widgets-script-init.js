 ...
 var dlabChartlist = function(){
	...
	var activityChart = function(){
		...
		if (activity !== null) {
			var activityData = [{
				...
				{
					first: [20, 35, 60, 45, 40, 80, 30, 80, 65, 80, 60, 35]
				},
				{
					first: [25, 88, 25, 50, 80, 80, 60, 80, 50, 60, 50, 80]
				}
			];
			activity.height = 300;
	...
	var activeUser = function(){
		if(jQuery('#activeUser').length > 0 ){
			var data = {
				...
				datasets: [{
					label: "My First dataset",
					backgroundColor: "rgba(58,223,184,1)",
					strokeColor: "rgba(58,223,184,1)",
					pointColor: "rgba(0,0,0,0)",
					pointStrokeColor: "rgba(58,223,184,1)",
					pointHighlightFill: "rgba(58,223,184,1)",
					pointHighlightStroke: "rgba(58,223,184,1)",
			...
			new Chart(chart_widget_2, {
				...
				data: {
					...
					datasets: [
						{
							label: "My First dataset",
							data: [65, 59, 80, 81, 56, 55, 40, 88, 45, 95, 54, 86],
	...
	var chartWidget8 = function(){
		...
		if(jQuery('#chart_widget_8').length > 0 ){
			chartReinitialize('#chart_widget_8');
		const chart_widget_8 = document.getElementById("chart_widget_8").getContext('2d');
		//generate gradient
		const chart_widget_8gradientStroke = chart_widget_8.createLinearGradient(0, 0, 0, 250);
		chart_widget_8gradientStroke.addColorStop(0, "#ff2c53");
		chart_widget_8gradientStroke.addColorStop(1, "#ff2c53");

			// chart_widget_8.attr('height', '100');

			new Chart(chart_widget_8, {
				type: 'bar',
				data: {
					defaultFontFamily: 'Poppins',
					labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
					datasets: [
						{
							label: "My First dataset",
							data: [65, 59, 80, 81, 56, 55, 40, 88, 45, 95, 54, 86],
							borderColor: chart_widget_8gradientStroke,
							borderWidth: "0",
							backgroundColor: chart_widget_8gradientStroke, 
							hoverBackgroundColor: chart_widget_8gradientStroke
						}
					]
				},
				options: {
	...
	var chartWidget9 = function(){
		...
		new Chart(chart_widget_9, {
			...
			data: {
				...
				datasets: [{
					label: "Sales Stats",
					backgroundColor: "#2880d4",
					borderColor: '#2880d4',
					pointBackgroundColor: '#2880d4',
					pointBorderColor: '#2880d4',
					pointHoverBackgroundColor: '#2880d4',
					pointHoverBorderColor: '#2880d4',
					data: [20, 10, 18, 15, 32, 18, 15, 22, 8, 6, 12, 13, 10, 18, 14, 24, 16, 12, 19, 21, 16, 14, 24, 21, 13, 15, 28, 29, 21, 11, 14, 19, 21, 18]
				}]
			},
			options: {
				title: {
		...
		if(jQuery('#chart_widget_18').length > 0 ){
			...
			const updateInterval = 1000;
				...
				if(jQuery('#chart_widget_18').length > 0 ){
				 ...
				 const chart = jQuery.plot('#chart_widget_18', [getRandomData()], {
					colors: ['#430b58'],
					series: {
						lines: {
							show: true,
	...
	var widgetSparkLinedash = function(){
		...
		if(jQuery('#widget_sparklinedash').length > 0 ){	 
			 $("#widget_sparklinedash").sparkline([10, 15, 26, 28, 28, 31, 34, 40, 41, 44, 49, 64, 68, 69, 82], {
				type: "bar",
				height: "40",
				width: "40",
				barWidth: "3",
				resize: !0,
				barSpacing: "3",
				barColor: "rgb(0, 181, 198)"
			});
		}
	}
	var widgetSparkBar = function(){
		if(jQuery('#widget_spark-bar').length > 0 ){	
			$("#widget_spark-bar").sparkline([33, 22, 68, 54, 8, 30, 84, 8, 36, 5, 41, 19, 43, 29, 38], {
				type: "bar",
				height: "40",
				barWidth: 3,
				barSpacing: 3,
				barColor: "rgb(8, 135, 234)"
			});
		}	
	}	
	...
	var widgetCompositeBar = function(){
		...
		if(jQuery('#widget_composite-bar').length > 0 ){
			$("#widget_composite-bar").sparkline([83, 53, 50, 68, 3, 56, 19, 59, 38, 32, 40, 26, 81, 19, 4, 53, 55, 31, 38, 68, 10, 21], {
				type: "bar",
				height: "40",
				barWidth: "3",
				resize: !0,
