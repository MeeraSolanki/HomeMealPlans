(function($) {
    ...
    var range = [
        '0', '2098152', '4194304',
        '8388608', '16888216', '33554432',
        '68108864', '134218828', '268435456',
        '536880912', '1083841824',
        '2148483648', '4294968296',
        '8589934592'
    ];
    ...
    noUiSlider.create(pipsValues, {
        ...
        pips: {
            mode: 'values',
            values: [50, 552, 2251, 3200, 5000, 8080, 9000],
            density: 4
        }
    });
    //pips values ^
    ...
    noUiSlider.create(pipsValuesStepped, {
        ...
        pips: {
            mode: 'values',
            values: [50, 552, 4651, 4952, 5000, 8080, 9000],
            density: 4,
            stepped: true
        }
    });
