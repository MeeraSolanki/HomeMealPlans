 ...
 var dzChartlist = function(){
	...
	var AllProject = function(){
       ...
       plotOptions: {
		 ...
		 colors: ['#3AC988', 'var(--primary)', 'var(--secondary)'],
	...
	var overiewChart = function(){
		 var options = {
          ...
          type: 'column',
          data: [85, 85, 82, 100, 50, 100, 80, 85, 95, 35, 85,100]
        }, {
          name: 'Revenue',
          type: 'area',
          data: [44, 65, 55, 85, 45, 55, 40, 60, 85, 45, 50,42]
        }, {
		...
		colors:["var(--primary)","#3AC988","#FF5E5E"],
		...
		$(".mix-chart-tab .nav-link").on('click',function(){
			...
			switch(seriesType) {
				case "week":
					columnData = [85, 85, 82, 100, 50, 100, 80, 85, 95, 35, 85,100];
					areaData = [44, 65, 55, 85, 45, 55, 40, 60, 85, 45, 50,42];
				...
				case "month":
					...
					lineData = [65, 45, 25, 65, 45, 25, 85, 35, 65, 85, 15,65];
					
					break;
				case "year":
					columnData = [30, 20, 80, 52, 10, 90, 50, 30, 95, 20, 60,85];
					areaData = [40, 25, 40, 45, 85, 25, 50, 65, 45, 60, 20,12];
					lineData = [65, 45, 30, 65, 45, 25, 85, 40, 65, 50, 15,65];
					break;
				case "all":
					columnData = [20, 50, 80, 60, 10, 80, 50, 40, 95, 20, 60,85];
					areaData = [40, 25, 30, 45, 85, 25, 95, 65, 50, 45, 20,12];
					lineData = [65, 45, 25, 65, 45, 25, 30, 35, 65, 85, 15,65];
					break;
				default:
					columnData = [85, 80, 82, 100, 50, 100, 80, 30, 95, 35, 85,100];
					areaData = [44, 65, 55, 85, 45, 55, 40, 60, 85, 45, 50,42];
	...
	var earningChart = function(){
		...
		var options = {
		  series: [
			{
				name: 'Net Profit',
				data: [800,650, 680, 600, 800, 610,810,620],
				/* radius: 30,	 */
			}, 				
		],
			chart: {
		...
		$(".earning-chart .nav-link").on('click',function(){
			...
			switch(seriesType) {
				case "day":
					columnData = [800,650, 680, 650, 800, 610,810,620];
					break;
				case "week":
					columnData = [800,800, 680, 600, 800, 620,810,620];
					break;
				case "month":
					columnData = [800,650, 690, 640, 800, 680,810,620];
					break;
				case "year":
					columnData = [800,650, 590, 650, 800, 610,810,630];
					break;
				default:
					columnData = [800,650, 680, 650, 800, 610,810,620];
			}
	...
	var projectChart = function(){
       ...
       plotOptions: {
		 ...
		 colors: ['#FF9F00', 'var(--primary)', '#3AC988','#FF5E5E'],
			labels: ["Compete", "Pending", "Not Start"],
			dataLabels: {
				enabled: false,
			},
