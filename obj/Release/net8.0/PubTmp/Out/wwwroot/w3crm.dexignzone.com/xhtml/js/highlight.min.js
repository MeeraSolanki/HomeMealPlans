...
;"object"==typeof t?(i=e,
n=t.ignoreIllegals,r=t.language):(X("10.8.0","highlight(lang, code, ...args) has been deprecated."),
X("10.8.0","Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2288"),
...
const[e,i]=s
;if(M.addText(n),n="",c[r]=(c[r]||0)+1,c[r]<=8&&(R+=i),e.startsWith("_"))n+=t[0];else{
...
highlightElement:w,
highlightBlock:e=>(X("10.8.0","highlightBlock will be removed entirely in v12.0"),
X("10.8.0","Please use highlightElement now."),w(e)),configure:e=>{g=Q(g,e)},
initHighlighting:()=>{
...
;hljs.registerLanguage("css",e)})();/*! `javascript` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
...
},u="\\.([0-9](_?[0-9])*)",m="0|[1-9](_?[0-9])*|0[0-8]*[89][0-9]*",E={
className:"number",variants:[{
begin:`(\\b(${m})((${u})|\\.)?|(${u}))[eE][+-]?([0-9](_?[0-9])*)\\b`},{
begin:`\\b(${m})\\b((${u})\\b|\\.)?|(${u})\\b`},{
begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{
begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{
begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-8](_?[0-8])*n?\\b"},{
begin:"\\b0[0-8]+n?\\b"}],relevance:0},A={className:"subst",begin:"\\$\\{",
...
scope:{1:"keyword",3:"title.class",5:"keyword",8:"title.class.inherited"}},{
...
},a.FUNCTION_DISPATCH]}}})();hljs.registerLanguage("scss",e)})();/*! `php` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
const t=e.regex,a=/(?![A-Za-z0-9])(?![$])/,r=t.concat(/[a-zA-Z_\x8f-\xff][a-zA-Z0-9_\x8f-\xff]*/,a),n=t.concat(/(\\?[A-Z][a-z0-9_\x8f-\xff]+|\\?[A-Z]+(?=[A-Z][a-z0-9_\x8f-\xff])){1,}/,a),o={
...
}})();hljs.registerLanguage("php",e)})();/*! `xml` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
